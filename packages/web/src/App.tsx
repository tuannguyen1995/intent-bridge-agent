...
// Minimalist Icons
const ActivityIcon = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>;
const ShieldIcon = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>;
...
const mockLogs = [
  ...
  "[AGENT] Idling. Monitoring mempool...",
];
      ...
      <nav className="navbar">
        <div className="nav-container">
          ...
          <div className="nav-center">
            ...
            <button className={`nav-tab ${activeTab === 'console' ? 'active' : ''}`} onClick={() => setActiveTab('console')}>Agent Console</button>
        ...
        {activeTab === 'overview' && (
          <div className="tab-section fade-in">
            <header className="section-header">
              ...
              <p className="subtitle">Real-time metrics and live orderbook across the Unicity network.</p>
            </header>
            ...
            <div className="content-card mt-8">
              ...
              <div className="table-wrapper">
                <table className="clean-table">
                  ...
                  <tbody>
                    <tr>
                      <td className="font-mono text-muted">0x8F1A...42B9</td>
                      <td>UCT</td>
                      <td>500.00</td>
                      <td>Base</td>
                    ...
                    <tr>
                      <td className="font-mono text-muted">0x9B2C...11A3</td>
                      <td>USDC</td>
                      <td>1,200.50</td>
                      <td>Arbitrum</td>
                      <td><span className="status-badge pending">Routing</span></td>
                    </tr>
                    <tr>
                      <td className="font-mono text-muted">0x3D8E...99FF</td>
                      <td>UCT</td>
                      <td>250.00</td>
                      <td>Optimism</td>
                    ...
                    <tr>
                      <td className="font-mono text-muted">0x1A2B...33C4</td>
                      <td>ETH</td>
                      <td>4.50</td>
                      <td>Unicity Testnet</td>
                      <td><span className="status-badge open">Open</span></td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="tab-section fade-in">
            ...
            <div className="console-grid">
                ...
                <div className="terminal-body" ref={terminalRef}>
                  {logs.map((log, index) => (
                    <div key={index} className="t-line">
                      ...
                      <span className={`t-msg ${log.includes('[SUCCESS]') ? 'text-green' : log.includes('[ERROR]') ? 'text-red' : 'text-white'}`}>
                        {log}
                      </span>
                    </div>
                  ))}
              ...
              <div className="content-card simulator-container">
                ...
                <button className="btn-primary full-width mt-4" onClick={runSimulation} disabled={simulating}>
        ...
        {activeTab === 'settings' && (
          <div className="tab-section fade-in">
            ...
            <div className="content-card settings-card">
              ...
              <div className="setting-row">
                <div className="s-info">
                  <h3>Nostr DM Fallback Negotiation</h3>
                  <p>Allow the agent to securely negotiate unmatched intents with counterparties via encrypted messages.</p>
                </div>
                <div className="s-action">
                  <label className="toggle">
                    <input type="checkbox" defaultChecked />
